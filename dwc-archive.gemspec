...
Gem::Specification.new do |gem|
  ...
  gem.required_ruby_version = ">= 3.3.0", "< 4.1"
  ...
  gem.add_development_dependency "cucumber", "~> 11.1"
  gem.add_development_dependency "git", "~> 4.3"
  gem.add_development_dependency "rake", "~> 13"
  gem.add_development_dependency "rspec", "~> 3.10"
  gem.add_development_dependency "rubocop", "~> 1.8"
  gem.add_development_dependency "rubocop-rake", "~> 0.7"
  gem.add_development_dependency "rubocop-rspec", "~> 3.10"
